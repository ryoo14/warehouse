...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { category: @warehouse.category, count: @warehouse.count, name: @warehouse.name } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { category: @warehouse.category, count: @warehouse.count, name: @warehouse.name } }
